...
observáveis}), sendo um ambiente acessível aquele que possibilita que o
agente explore todas as suas características. Ambientes acessíveis permitem que
o agente não precise guardar informações sobre o mesmo, visto que pode sempre
...
\begin{itemize}
    \item Falar que é uma arquitetura de agentes
    \item Explicar porque usar
    \item Explicar os conceitos de crenças, desejos e intenções
    \item Explicar suas limitações
\end{itemize}
...
\begin{itemize}
    \item O que é
    \item Para que serve
    \item Como se faz (forma abstrata)
\end{itemize}
