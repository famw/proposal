...
crenças tratam-se de informações que o agente acredita saber sobre o ambiente.
...
tratam-se dos estados os quais um agente deseja atingir. As intenções
representam o plano de ação que um agente BDI se compromete em busca dos seus
desejos. Com estes três conceitos, é possível definir um algoritmo
