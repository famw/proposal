...
conforme as características do ambiente. Quando são fornecidos ao agente
exemplos de execução e resultados esperados, chamamos de \textbf{aprendizado
supervisionado}. Neste tipo de aprendizado, a tarefa do agente consiste em
detectar padrões e aprender a "mapear" entradas para resultados. Por outro
lado, quando não se tem nenhuma informação inicial sobre resultados esperados e
nenhum tipo de retorno é fornecido para execuções de ações, chamamos de
\textbf{aprendizado por reforço}. Este tipo de aprendizado geralmente é
empregado quando se quer descobrir novas informações sobre um conjunto de
dados. Em \textbf{aprendizado por reforço}, é fornecido ao agente algum tipo de
retorno -- como recompensas e punições -- ao agente quando ele executa ações.
Assim, o agente saberá se está agindo de maneira correta para resolver o
problema proposto \cite{Russell:1995:AIM:193191}.
