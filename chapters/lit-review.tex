...
computador a fazer o mesmo é uma tarefa bem mais difícil de se expressar
algoritmicamente.
...
têm como objetivo simular o cérebro humano, fazendo o uso de algoritmos e
fórmulas matemáticas para fazer com que uma máquina seja capaz de pensar e
raciocinar de forma semelhante como os humanos fazem. A ideia geral de tal
técnica consiste em, através das estruturas do cérebro simuladas
algoritmicamente, obter as percepções que o agente precisa e tomar decisões com
base nelas. Além disso, as decisões tomadas por uma rede neural são baseadas no
conhecimento obtido através do que se é chamado de \textbf{treinamento}, que
consiste em aprender através de exemplos, fazendo com que os neurônios
implementados através de algoritmos compreendam os padrões estabelecidos nos
exemplos - também chamados de conjuntos de treinamento - e passem a ter uma
espécie de consciência, tornando-se cada vez mais assertivos em relação ao
quanto são treinados, sendo capazes assim de raciocionar e resolver os próximos
problemas por si só (sem a necessidade de treinamento).

Tal estudo permite que problemas como pronunciação de palavras e frases,
