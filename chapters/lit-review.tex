...
ilustra uma partida do jogo, que segue o estilo \textit{platformer} - tipo de
jogo que envolve guiar um personagem através de plataformas suspensas e
obstáculos para obter progresso no jogo.
...
enquanto o programa está em execução. A Figura
\ref{fig:spelunkbots-debug-screen} demonstra o uso desta funcionalidade. Os
criadores da competição disponibilizam alguns \textit{bots} e níveis básicos
