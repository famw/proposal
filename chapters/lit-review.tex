...
\textit{objetivos} e \textit{ações}. Isso permite que o planejador possa fazer
uma ligação direta entre as ações e os estados, podendo, portanto, considerar
...
executar uma ação, tenha que ter um conhecimento prévio do ambiente. Assim,
após executar a ação, seus efeitos alteram o conhecimento sobre o ambiente. O
uso de uma linguagem formal nessa tarefa permite que os componentes de um
planejador sejam expressos de uma maneira onde seja possível realizar
operarações sobre tais conjecturas, facilitando o processo de geração de um
