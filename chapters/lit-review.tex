...
ambiente. O jogo 2D segue o estilo \textit{platformer} - tipo de jogo que
...
\textbf{Comerciantes}. Estes \textit{NPCs}\footnote{\textit{Non-Playable
...
para a comunidade do jogo é um dos fatores que ajuda a manter sua base de
jogadores e atraem novos jogadores até hoje.
...
árvores de decisão e redes neurais \footnote{Explica-se o funcionamento destas
...
pois ajudam a motivar os pesquisadores, além de resultar na adesão de novos
pesquisadores.  Estas são algumas das características dos jogos digitais que
fazem com que sejam atraentes para pesquisadores da área de inteligência
artificial.
...
ambiente de \textbf{semi-dinâmico}.
