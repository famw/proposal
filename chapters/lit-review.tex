...
A solução de muitos tipos de problemas pode ser expressa através de uma
sequência de ações a serem executadas - isto é, um plano. Portanto, em muitos
dos casos, é necessário que um agente consiga pensar sobre o que deve ser feito
para resolver o problema o qual foi designado, seguindo as ações que resolvam o
mesmo.
...
não temos certeza sobre o estado do ambiente e nem sobre o resultado de nossas
...
extensão da representação de estados, objetivos e ações com o uso de algum tipo
de linguagem formal (normalmente lógica de primeira ordem, ou algum subconjunto
da mesma). Isso permite com o planejador possa fazer uma ligação direta entre
...
após a execução da mesma, os seus efeitos fazem com que seja alterado o
conhecimento sobre o ambiente.

O uso de uma linguagem formal nessa tarefa permite com que os componentes de um
